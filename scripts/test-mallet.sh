...
java -cp "$MALLET_HOME/class:$MALLET_HOME/lib/mallet-deps.jar" cc.mallet.fst.SimpleTagger --include-input true --model-file nouncrf /var/lib/myfrdcsa/codebases/minor/ies/scripts/stest
